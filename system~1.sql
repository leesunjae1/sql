...
grant all on hr.departments to you; --system

drop table employees cascade constraints;
create table employees(
employee_id number(6) constraint emp_empid primary key,
...
gu_id number(3) references gu(gu_id) on delete cascade); --부모가 지워지면 자식도 지워진다
